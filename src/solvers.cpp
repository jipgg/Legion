...
std::array<Vec2f, 2> solvers::velocities_after_collision(
...
bool solvers::is_overlapping(const Recti64 &a, const Recti64 &b) {
...
bool solvers::is_in_bounds(const Vec2i16& point, const Recti64& bounds) {
